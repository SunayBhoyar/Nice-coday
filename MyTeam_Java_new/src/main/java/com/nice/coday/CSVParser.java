...
public class CSVParser{
    ...
    // public static List<ChargingStation> readVehicleTypeData(Path csvPath) {
    //     List<ChargingStation> stationList = new ArrayList<>();
    ...
    //     return stationList;
    // }
    public static List< VehicleType> readVehicleTypeData(Path csvPath) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvPath.toString()))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                String vehicleTypeName = values[0];
                ...
                VehicleType vehicleType = new VehicleType(vehicleTypeName,numberOfUnitsForFullyCharge, mileage);
